...
Click [here]([https://drive.google.com/drive/folders/1vU1Anan3YtzQtytoexMRNnEJULtM2Den?usp=drive_link](https://drive.google.com/drive/folders/1vU1Anan3YtzQtytoexMRNnEJULtM2Den?usp=sharing)) for downloading genomes files required for the tutorials. After installing genome_rearangement with git clone, place the downloaded genomes files in ~/genome_rearrangement/example_data for later use.
