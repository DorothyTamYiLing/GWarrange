...
myx$fwdk_0gen_med_round<-round_any(myx$fwdk_0gen_med, as.numeric(as.character(opt$intkrd)))
myx$revk_0gen_med_round<-round_any(myx$revk_0gen_med, as.numeric(as.character(opt$intkrd)))
myx$fwdk_1gen_med_round<-round_any(myx$fwdk_1gen_med, as.numeric(as.character(opt$intkrd)))
myx$revk_1gen_med_round<-round_any(myx$revk_1gen_med, as.numeric(as.character(opt$intkrd)))
