...
if [[ ($merge != 3 || $extend != 100) && $switch == "on" ]]  #if merge or extend arguments is provided and larger than default values, and switch for minimal ISmerg is on as default
then
